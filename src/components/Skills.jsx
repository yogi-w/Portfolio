...
<div name='skills' className='mb-10'>
    ...
    <div className='m-w-full m-auto px-6 md:px-30 md:my-20 my-10 '>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 md:my-20 gap-x-35 lg:gap-x-20 gap-y-10 place-items-center'>
            
            <div className='lg:px-7 hover:scale-105 duration-200 hover:shadow-blue-500/100 shadow-xl border-blue-400 flex flex-col gap-4 border-1 items-center w-[200px] justify-center mx-auto md:mx-0 md:w-[220px] py-9 rounded-xl'>
